...
function(e) {
    ...
    _ = function() {
        ...
        (e = /(?=.+Mac OS X)(?=.+Firefox)/.test(t)) ? (i = /Firefox\/\d{2}\./.exec(t), i && (i = i[0].replace(/\D+/g, "")), e && +i > 23) : !1
    },
    g = function() {
        function c(i, s) {
            this.el = i,
        ...
        return c.prototype.preventScrolling = function(e, n) {
            if (this.isActive) if (e.type === s)(n === o && e.originalEvent.detail > 0 || n === x && e.originalEvent.detail < 0) && e.preventDefault();
            else if (e.type === v) {
                if (!e.originalEvent || !e.originalEvent.wheelDelta) return; (n === o && e.originalEvent.wheelDelta < 0 || n === x && e.originalEvent.wheelDelta > 0) && e.preventDefault()
            }
        },
        ...
        c.prototype.addEvents = function() {
            ...
            this.iOSNativeScrolling || (this.slider.bind(d, e[o]), this.pane.bind(d, e[m]).bind("" + v + " " + s, e[S])),
        ...
        c.prototype.generate = function() {
            ...
            0 === a && _() ? (i = n.getComputedStyle(this.content, null).getPropertyValue("padding-right").replace(/[^0-9.]+/g, ""), t = {
                right: -14,
                paddingRight: +i + 14
            }) : a && (t = {
                right: -a
        ...
        c.prototype.stop = function() {
            return w && this.scrollRAF && (w(this.scrollRAF), this.scrollRAF = null),
            this.stopped = !0,
            this.removeEvents(),
    ...
    e.fn.nanoScroller = function(n) {
        return this.each(function() {
            var t, i;
            if ((i = this.nanoscroller) || (t = e.extend({},
            k, n), this.nanoscroller = i = new g(this, t)), n && "object" == typeof n) {
...
function(e) {
    ...
    var i = (n(e), "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ?
    function(e) {
        return typeof e
    }: function(e) {
    ...
    function(e) {
        ...
        function s() {
            ...
            for (var n in m) if (void 0 !== e.style[n]) return {
                end: m[n]
            };
            return ! 1
        }
            ...
            },
            {
                ...
                value: function(t) {
                    return this.each(function() {
                        ...
                        s = a.data(c),
                        o = e.extend({},
                        p, a.data(), "object" === ("undefined" == typeof t ? "undefined": i(t)) && t);
...
function(e) {
    ...
    e(document).on("nifty.ready",
    function() {
        var n = e(".add-tooltip");
        n.length && n.tooltip();
        var t = e(".add-popover");
        t.length && t.popover(),
        e("#navbar-container .navbar-top-links").on("shown.bs.dropdown", ".dropdown",
        function() {
...
function(e) {
    ...
    function() {
        n = e(".mega-dropdown"),
        n.length && (n.niftyMega(), e("html").on("click",
        function(t) {
...
function(e) {
    ...
    function() {
        ...
        n.length ? n.one("click",
        function(n) {
            n.preventDefault();
            var t = e(this).parents(".panel");
            t.addClass("remove").on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",
            function(e) {
...
function(e) {
    ...
    i = {
        show: function(n) {
            ...
            return n.prop("disabled", !0).data("niftyOverlay", a),
        ...
        hide: function(n) {
            ...
            return i.length && (n.prop("disabled", !1), t.removeClass("panel-overlay-wrap"), i.hide().remove()),
            null
        }
    },
    a = function(t, i) {
    ...
    e.niftyNoty = function(r) {
        {
            ...
            v = function() {
                return f.onHide(),
                "floating" === f.container && f.floating.animationOut && (d.removeClass(f.floating.animationIn).addClass(f.floating.animationOut), l || (f.onHidden(), d.remove())),
                d.removeClass("in").on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",
                function(e) {
            ...
            function() {
                if (f.onShow(), "page" === f.container) n || (n = e('<div id="page-alert"></div>'), s && s.length || (s = e("#content-container")), s.prepend(n)),
                i = n,
                f.focus && g(0);
                else if ("floating" === f.container) t[f.floating.position] || (t[f.floating.position] = e('<div id="floating-' + f.floating.position + '" class="floating-container"></div>'), a && s.length || (a = e("#container")), a.append(t[f.floating.position])),
                ...
                f.focus = !1;
                    ...
                    if (!l.length) return o = !1,
                    !1;
                    r.length ? i = r: (i = e('<div class="panel-alert"></div>'), c.length ? c.after(i) : l.prepend(i)),
        ...
        if (o) {
            ...
            200);
            d.one("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd",
            function(e) {
...
function(e) {
    ...
    t = function(t, i) {
        ...
        l.on("click",
        function(n) {
            a.dynamicMode && (n.preventDefault(), n.stopPropagation()),
            t.dropdown("toggle"),
            f(e(this))
        }),
...
function(e) {
        ...
        if (!n.data("nifty-check")) {
            ...
            s = function() {
                "radio" == t.type && a.length && a.each(function() {
                    var n = e(this);
                    n.hasClass("active") && n.trigger("nifty.ch.unchecked"),
    ...
    i = {
        ...
        toggleOn: function() {
            return this[0].checked || (this[0].checked = !0, this.trigger("change")),
            null
        },
        toggleOff: function() {
            return this[0].checked && "checkbox" == this[0].type && (this[0].checked = !1, this.trigger("change")),
            null
        }
    },
    a = function() {
        n = e(".form-checkbox, .form-radio"),
        n.length && n.niftyCheck()
    };
    ...
    e(document).on("nifty.ready", a).on("change", ".form-checkbox, .form-radio", a).on("change", ".btn-file :file",
    function() {
        var n = e(this),
...
function(e) {
    ...
    p = function() {
        ...
        i.each(function() {
            ...
            e("#mainnav-menu-wrap > .nano").on("update",
            function() {
            ...
            s.popover({
                ...
                content: function() {
                    var n;
                    return y ? (n = e('<div class="sub-menu"></div>'), l.addClass("pop-in").wrap('<div class="nano-content"></div>').parent().appendTo(n)) : r.length ? (n = e('<div class="sidebar-widget-popover"></div>'), r.wrap('<div class="nano-content"></div>').parent().appendTo(n)) : n = '<span class="single-content">' + o.html() + "</span>",
                    n
                },
            ...
            function() {
                ...
                i > l ? (d.length && !d.is(":visible") && (o = Math.round(0 - .5 * o)), i -= 5, u.css({
                    top: "",
                    bottom: o + "px",
                    height: i
            ...
            function() {
                ...
                i.popover("hide"),
                s.addClass("hover").popover("show").one("hidden.bs.popover",
                function() {
                    s.removeClass("hover"),
    ...
    g = function() {
        ...
        f != i && (f = i, c = i, "sm" == c && t.hasClass("mainnav-lg") ? e.niftyNav("collapse") : "xs" == c && t.hasClass("mainnav-lg") && t.removeClass("mainnav-sm mainnav-out mainnav-lg").addClass("mainnav-sm"))
    },
    m = function() {
    ...
    C = function() {
        ...
        g(),
        m(),
        ("collapse" == l || t.hasClass("mainnav-sm")) && (t.removeClass("mainnav-in mainnav-out mainnav-lg"), p()),
        s = e("#mainnav").height(),
        l = !1,
        null
    },
    T = {
        ...
        pushToggle: function() {
            t.toggleClass("mainnav-in mainnav-lg").removeClass("mainnav-in mainnav-out mainnav-sm"),
...
//          return t.toggleClass("mainnav-lg mainnav-out").removeClass("mainnav-in mainnav-out"),
//          r && v();
//      },
        colExpToggle: function() {
				return t.hasClass("mainnav-lg mainnav-sm") && t.removeClass("mainnav-in mainnav-lg"), t.toggleClass("mainnav-lg mainnav-sm").removeClass("mainnav-in mainnav-out")
			},
        collapse: function() {
        ...
        bind: function() {
            ...
            function(n) { (r || n.target === a[0]) && (clearInterval(r), r = setInterval(function() {
            ...
            function(n) {
                n.preventDefault(),
                n.stopPropagation(),
                e.niftyNav(c.hasClass("push") ? "pushToggle": c.hasClass("slide") ? "slideToggle": c.hasClass("reveal") ? "revealToggle": "colExpToggle")
            });
            try {
                l.metisMenu({
                    toggle: !0
    ...
    e.niftyNav = function(e, n) {
        if (T[e]) { ("colExpToggle" == e || "expand" == e || "collapse" == e) && ("xs" == c && "collapse" == e ? e = "pushOut": "xs" != c && "sm" != c || "colExpToggle" != e && "expand" != e || !t.hasClass("mainnav-sm") || (e = "pushIn"));
...
function(e) {
    ...
    f = function() {
        if (n = e("#aside-container"), n.length) {
            t = e("#container"),
            i.on("resizeEnd", c),
            n.on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",
            function(e) {
...
function(e) {
    ...
    e.fn.niftyAffix = function(n) {
        return this.each(function() {
            var a, t = e(this);
            "object" != typeof n && n ? "update" == n ? (t.data("nifty.af.class") || r(), a = t.data("nifty.af.class"), l(t)) : "bind" == n && r() : (a = n.className, t.data("nifty.af.class", n.className)),
            i.hasClass(a) && !i.hasClass("navbar-fixed") ? t.affix({
                offset: {
                    top: e("#navbar").outerHeight()
                }
            }).on("affixed.bs.affix affix.bs.affix",
            function() {
                l(t)
